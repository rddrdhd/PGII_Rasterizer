...
int run() {
	int option = 1; // 0, 1, 2 for avenger, cube and geospheres
	...
	if (option == 0) {
		...
		g->getPrefilteredEnvMap(1.0f, 512, 256, "../../../data/maps/lebombo_prefiltered_env_map/0.exr").Save("../../../data/maps/generated_prefenv_1_0.exr");
	}
